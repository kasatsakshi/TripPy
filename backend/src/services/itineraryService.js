...
export class ItineraryService {
  ...
  generate = async (req, res) => {
    try {
      console.log("from generate: " + JSON.stringify(req.body));
      ...
      const itineraryObject = await this.getItineraryById(req.body)
  ...
  getItineraryById = async (body) => {

    try {
      const { startDate, endDate, duration, location, interests, budget, userId, itineraryId } = body;
      const data = {
